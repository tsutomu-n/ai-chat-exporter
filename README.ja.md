...
- `ai-chat-export.unified.bookmarklet.oneliner.js`
  - 簡易結果ダイアログに寄せた統合版
  - Firefox でブックマーク保存しやすい側

`ai-chat-export.bookmarklet.oneliner.js` はブラウザによっては長すぎて保存できないことがあります。統合版を 1 本で使いたい場合は、まず `ai-chat-export.unified.bookmarklet.oneliner.js` を試すのが安全です。通常は分割版を使う方がさらに安定します。過去の高機能版、派生版、Console 用、ローダー版は [`archive/README.ja.md`](/home/tn/projects/ai-chat-exporter/archive/README.ja.md) に退避しています。

## 最短手順

1. `ai-chat-export.chatgpt-claude.bookmarklet.oneliner.js` または `ai-chat-export.aistudio-grok.bookmarklet.oneliner.js` を開く
...
- `ai-chat-export.unified.bookmarklet.oneliner.js`
  - ASCII ベースの軽量統合版
  - 結果確認 UI を削って Firefox 向けに寄せた版
- `ai-chat-export.chatgpt-claude.bookmarklet.oneliner.js`
  - ChatGPT / Claude 向け推奨
- `ai-chat-export.aistudio-grok.bookmarklet.oneliner.js`
  - Google AI Studio / Grok 向け推奨
- `ai-chat-export.claude.bookmarklet.oneliner.js`
  - Claude 専用の最短版
